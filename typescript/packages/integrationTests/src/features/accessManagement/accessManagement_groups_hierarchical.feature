...
Feature:
	...
	Scenario: Setup users
		And  group / has user accessManagement_hierarchical_admin@amazon.com with role admin and password p@ssword1

	Scenario: Admin should be able to set default configuration in root group
		Given I authenticate using email accessManagement_hierarchical_admin@amazon.com and password p@ssword1
	...
	Scenario: Admin should be able to create a new child group that inherit application configuration from parent
		Given I authenticate using email accessManagement_hierarchical_admin@amazon.com and password p@ssword1
		And I set body to {"name": "accessmanagementhierarchicalgrouptests1"}
		When I POST to /groups
		Then response code should be 201
		And response header x-groupid should be /accessmanagementhierarchicalgrouptests1
		And response body path $.id should be /accessmanagementhierarchicalgrouptests1
		And response body path $.name should be accessmanagementhierarchicalgrouptests1
	...
	Scenario: When listing group it should not include the configuration field in the payload
		Given I authenticate using email accessManagement_hierarchical_admin@amazon.com and password p@ssword1
		When I GET /groups
		Then response body path $.groups[?(@.id=='/accessmanagementhierarchicalgrouptests1')].id should be /accessmanagementhierarchicalgrouptests1
		Then response body path $.groups[?(@.id=='/accessmanagementhierarchicalgrouptests1')].configuration should be null
	...
	Scenario: Admin should be able to create a nested child group
		...
		And I set x-groupcontextid header to /accessmanagementhierarchicalgrouptests1
		And I set body to {"name": "accessManagementGroupTests2"}
		When I POST to /groups
		Then response code should be 201
		And response header x-groupid should be /accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2
		And response body path $.id should be /accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2
		...
		And I set x-groupcontextid header to /accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2
		And I set body to {"name": "accessManagementGroupTests3"}
		When I POST to /groups
		Then response code should be 201
		And response header x-groupid should be /accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2/accessmanagementgrouptests3
		And response body path $.id should be /accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2/accessmanagementgrouptests3
	...
	Scenario: Retrieving reference datasets with includeParentGroups and includeChildGroups should return resources up and down the hierarchy.
		...
		And response body path $.groups[?(@.id=='/accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2')].id should be /accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2
		...
		And response body path $.groups[?(@.id=='/accessmanagementhierarchicalgrouptests1')].id should be /accessmanagementhierarchicalgrouptests1
		And response body path $.groups[?(@.id=='/accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2')].id should be /accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2
		When I GET /groups?includeChildGroups=true
		Then response code should be 200
		And response body path $.groups.length should be 2
		And response body path $.groups[?(@.id=='/accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2')].id should be /accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2
		And response body path $.groups[?(@.id=='/accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2/accessmanagementgrouptests3')].id should be /accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2/accessmanagementgrouptests3
	...
	Scenario: Active groups cannot be deleted
		...
		And I DELETE /groups/%2faccessmanagementhierarchicalgrouptests1
	...
	Scenario: Disabled groups cannot be deleted if it contains sub groups
		...
		And I PATCH /groups/%2faccessmanagementhierarchicalgrouptests1
		Then response code should be 200
	...
	Scenario: Disabled groups with no sub groups can be deleted
		...
		And I set x-groupcontextid header to /accessmanagementhierarchicalgrouptests1/accessmanagementgrouptests2
		And I set body to {"state": "disabled"}
		And I PATCH /groups/%2faccessmanagementhierarchicalgrouptests1%2faccessmanagementgrouptests2%2faccessmanagementgrouptests3
		Then response code should be 200
		And response body path $.state should be disabled
		When I remove header Content-Type
		And I DELETE /groups/%2faccessmanagementhierarchicalgrouptests1%2faccessmanagementgrouptests2%2faccessmanagementgrouptests3
		...
		And I set x-groupcontextid header to /accessmanagementhierarchicalgrouptests1
		And I set body to {"state": "disabled"}
		And I PATCH /groups/%2faccessmanagementhierarchicalgrouptests1%2faccessmanagementgrouptests2
		Then response code should be 200
		And response body path $.state should be disabled
		When I remove header Content-Type
		And I DELETE /groups/%2faccessmanagementhierarchicalgrouptests1%2faccessmanagementgrouptests2
		Then response code should be 204
		# Delete accessmanagementhierarchicalgrouptests1
		When I set Content-Type header to application/json
		And I GET /groups/%2faccessmanagementhierarchicalgrouptests1%2faccessmanagementgrouptests2
		Then response code should be 404
		When I remove header Content-Type
		And I DELETE /groups/%2faccessmanagementhierarchicalgrouptests1
		Then response code should be 204
		When I set Content-Type header to application/json
		And I GET /groups/%2faccessmanagementhierarchicalgrouptests1
		Then response code should be 404
	...
	Scenario: Teardown - delete user
		And group / has user accessManagement_hierarchical_admin@amazon.com revoked
