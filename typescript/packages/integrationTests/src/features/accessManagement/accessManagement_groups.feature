...
Feature:
	...
	Scenario: Setup users
		Given group / has user accessManagement_group_contributor@amazon.com with role contributor and password p@ssword1
		And  group / has user accessManagement_group_admin@amazon.com with role admin and password p@ssword1
	...
	Scenario: Contributor cannot create a new group
		...
		Given I authenticate using email accessManagement_group_contributor@amazon.com and password p@ssword1
	...
	Scenario: Teardown - delete user
		Given group / has user accessManagement_group_contributor@amazon.com revoked
		And group / has user accessManagement_group_admin@amazon.com revoked
