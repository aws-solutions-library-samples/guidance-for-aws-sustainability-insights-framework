...
import type { LambdaRequestContext, MetricClient } from '@sif/clients';
...
import type { Transformer } from '@sif/clients';
...
describe('SqlResultProcessorTaskService', () => {
		...
		beforeEach(() => {
			...
			underTest = new SqlResultProcessorTask(logger, mockPipelineProcessorsRepository, mockMetricClient, getLambdaContext, mockActivitiesRepository, mockEventPublisher);
		});
